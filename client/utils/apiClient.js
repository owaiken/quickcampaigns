...
const apiClient = axios.create({
  baseURL: (process.env.NEXT_PUBLIC_API_URL && process.env.NEXT_PUBLIC_API_URL.endsWith('/') ? process.env.NEXT_PUBLIC_API_URL : process.env.NEXT_PUBLIC_API_URL + '/') || 'http://localhost:8000/',
  timeout: 10000,
  headers: {
